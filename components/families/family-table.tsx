  ...
  return (
    <div className="flex flex-col gap-4" suppressHydrationWarning>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link href="/keluarga/tambah" className={buttonVariants()}>
                ...
                <TableRow key={family.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                      <Link href={`/keluarga/${family.id}`} className={buttonVariants({ variant: 'ghost', size: 'icon' })}>
                        <Eye className="h-4 w-4" />
                        <span className="sr-only">Lihat</span>
                      </Link>
                      <Link href={`/keluarga/${family.id}/edit`} className={buttonVariants({ variant: 'ghost', size: 'icon' })}>
